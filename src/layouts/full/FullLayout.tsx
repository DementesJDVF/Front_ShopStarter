  ...
  return (
    <>
      <div className="flex w-full min-h-screen bg-transparent relative">
        ...
        <div
          className={`xl:block hidden fixed left-0 top-0 h-screen bg-[#0A014A] transition-all duration-300 border-r border-white/5 z-20 ${isHovered ? 'w-64' : 'w-20'}`}
        >
          ...
          <aside
            className="h-full z-40 transition-all duration-300 ease-in-out relative overflow-hidden bg-transparent"
        ...
        <div
          className={`flex flex-col flex-grow min-h-screen relative z-10 bg-transparent dark:bg-darkgray transition-all duration-300 ${isHovered ? 'xl:ml-64' : 'xl:ml-20'}`}
        >
          <Header />
